...
This section gets you from install to a first working 3D patch quickly.

## Path

1. [Installation](./installation.md)
2. [Quickstart](./quickstart.md)
3. [First Patch](./first-patch.md)
...
See [Hydra in triode](../interop/hydra-in-triode.md) for a direct mapping.
