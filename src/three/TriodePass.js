...
import {TriodeShader, TriodeVertexShader} from "../lib/TriodeShader.js";
...
class TriodeFadePass extends TriodeMaterialPass
{
    constructor(options, uniforms) {
        ...
        const passOptions = {
            ...
            frag: new TriodeShader(THREE.GLSL1, ['', `
      varying vec2 vUv;
    ...
    `], '', `
      ...
      gl_FragColor = color;
    `),
            vert: new TriodeVertexShader({ glslName: 'clear' }, null, null, {useCamera: camera}),
